...
class TestMind(FindGridSizeMind, MappingMind, GreedyExplore, GoToPosition, Cleaner,Plunger):
    ...
    def decide(self):
        ...
        if self.grid_size > 0:
            ...
            # Places a value on each cell by how long ago it was explored
            # and if there are other agents that are closer.
            # targests the most expensive cell
...
vacuumworld.run(TestMind(), skip=True, load='example_map')
